...
python lib/test/utils/transform_got10k.py --tracker_name ostrack --cfg_name base_224_300

# TrackingNet
python tracking/test.py lorat base_224 --dataset trackingnet --threads 2 --num_gpus 2
python lib/test/utils/transform_trackingnet.py --tracker_name ostrack --cfg_name base_224_300