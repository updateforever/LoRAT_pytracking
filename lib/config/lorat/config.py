...
cfg.MODEL.BACKBONE.TYPE = "ViT-B/14"
...
# MODEL.LORA  lora_dropout: float, use_rslora: bool = False
cfg.MODEL.LORA = edict()
cfg.MODEL.LORA.LORA_R = 64
cfg.MODEL.LORA.LORA_ALPHA = 64
cfg.MODEL.LORA.LORA_DROPOUT = 0.
...
cfg.TRAIN.GIOU_WEIGHT = 1.0
cfg.TRAIN.BCE_WEIGHT = 1.0
...
cfg.TRAIN.IOU_AWARE_CLASSIFICATION_SCORE = True
...
cfg.DATA.SEARCH.MIN_OBJECT_SIZE = 10
# DATA.TEMPLATE
...
cfg.DATA.TEMPLATE.MIN_OBJECT_SIZE = 0
