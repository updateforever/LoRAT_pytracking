...
from lib.utils.bbox.format import bbox_get_width_and_height, bbox_get_center_point
from lib.utils.bbox.scale_and_translate import bbox_scale_and_translate
from lib.utils.bbox.utility.image import get_image_center_point, is_bbox_intersecting_image, bbox_clip_to_image_boundary_

from lib.train.data.scale_and_translate import scale_and_translate, scale_and_translate_subpixel, reverse_scale_and_translation_parameters
...
def get_scale_and_translation_factors(bbox: np.ndarray, area_factor: float, output_size: np.ndarray):
    ...
    source_center = bbox_get_center_point(bbox)  # (cx, cy)
