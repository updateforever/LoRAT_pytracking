...
def sample_target(im, target_bb, search_area_factor, output_sz=None, mask=None, padding_value=None):
    ...
    # Pad
    im_crop_padded = cv.copyMakeBorder(im_crop, y1_pad, y2_pad, x1_pad, x2_pad, cv.BORDER_CONSTANT,value=padding_value)
